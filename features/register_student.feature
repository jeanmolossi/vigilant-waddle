Feature: register student
	...
	Scenario: Register user should update an user if has current user from another scope
		Given there are "users" with:
			| usr_id								| usr_email		| usr_scope	| usr_password													|
			| f61139d7-1fe6-451f-b892-c96be729ce1d	| john@doe.com	| producer 	| $2a$10$sPrAnxt9E5TUzfeUl7WYge4C6gpSpnyyxJWeRg82j.eFCTthT6uKC	|
		When I "POST" to "/student" with:
		"""
		{
			"email": "john@doe.com",
